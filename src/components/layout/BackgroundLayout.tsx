    ...
    <div className={styles.background}>
      ...
      <div className={styles.about}>
        ...
        <p className={styles.footerText}>
          우리는 구름 DEEP DIVE에서 함께 협업하며 하나의 서비스를 완성하는 학습 기반<br /> 프로젝트 팀입니다.
          각자 다른 배경과 강점을 가진 팀원들이 모여, 사용자에게 실질적이고<br /> 가치 있는 경험을 제공하는 것을 목표로 개발했습니다.
          이번 프로젝트를 통해 우리는<br /> 기술 역량뿐 아니라 소통, 문제 해결, 역할 분담, 협업에 대한
          깊은 이해를 쌓고 있습니다.<br />   

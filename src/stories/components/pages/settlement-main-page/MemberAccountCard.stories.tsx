...
const mockMembers: MemberAccount[] = [
  { name: "김민수", initial: "김민", bank: "신한", account: "110-***-1234", accountForCopy: "1101234567890" },
  { name: "최짜장", initial: "최짜", bank: "신한", account: "110-***-1234", accountForCopy: "1101234567891" },
  { name: "김민수", initial: "김민", bank: "신한", account: "110-***-1234", accountForCopy: "1101234567892" },
  { name: "박지훈", initial: "박지", bank: "국민", account: "123-***-5678", accountForCopy: "1234567890123" },
  { name: "이예슬", initial: "이예", bank: "농협", account: "352-***-7890", accountForCopy: "3521234567890" },
];

...
* 맛집 목록은 **거리순**, **관련도순**, **카테고리(한식/양식/카페 등)** 로 정렬이 가능합니다.
* 맛집을 선택하면 **위치, 주소, 연락처, 네이버지도 이동, 공유** 등의 상세정보를 확인할 수 있습니다.
* 전화번호, 계좌번호 등은 **복사하기 기능**으로 편리하게 사용할 수 있습니다.
* 지역별 맛집탐방 페이지에서는 **직접 촬영한 사진 업로드**를 통한 “맛도장 찍기” 기능을 사용할 수 있습니다.
* 각 지역마다 **방명록 작성 및 열람**이 가능합니다.
